...
```{r, fig.align="center", fig.width=10, fig.cap="Scatter plot of AF of two samples"}
ggplotly(pairedAFplot(dat, case = "1607", control = "1885"))
```

#### comparison of t=40 of first/second generation

```{r, fig.align="center", fig.width=10, fig.cap="Scatter plot of AF of two samples"}
ggplotly(pairedAFplot(dat, case = "1660", control = "1807"))
```

#### comparison of t=80 of first/second generation

```{r, fig.align="center", fig.width=10, fig.cap="Scatter plot of AF of two samples"}
ggplotly(pairedAFplot(dat, case = "1779", control = "1789"))
```
